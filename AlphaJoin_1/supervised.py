...
class supervised:
    ...
    def supervised(self):
        self.load_data()
        optim = torch.optim.SGD(self.value_net.parameters(), lr=0.001)  # 优化器
        # optim = torch.optim.Adam(self.value_net.parameters(), lr=0.001)
        ...
        for step in range(1, 300001):
            ...
            #     state_tensor = state_tensor.unsqueeze(0)  # 转换为二维
            ...
            if step % 1000 == 0:
                ...
                # print('[{}]  Epoch: {}, Loss: {:.5f}'.format(datetime.now(), step, loss1000))
            if step % 1000 == 0:
                torch.save(self.value_net.state_dict(), self.args.save_dir + 'supervised_op_0613_1.pt')
                ...
                if self.test_network() > max_correct:
                    ...
                    torch.save(self.value_net.state_dict(), self.args.save_dir + 'supervised_best_op_0613_1.pt')
        ...
        plt.savefig('accuracy_300000_op_0613_1.png')
        # plt.show()
        ...
        plt.savefig('loss_300000_op_0613_1.png')
        # plt.show()
    ...
    def test_network(self):
        ...
        self.load_data()
        model_path = self.args.save_dir + 'supervised_op_0613_1.pt'
